...
public class Ship extends GamePhysicObject implements ControlledEntity,
	...
	public void draw() {
		 ...
		 * RenderTextUtil.getInstance().drawText(position.x - 60, position.y +
		 * 30, "SHIP1", org.newdawn.slick.Color.green, 1f);
